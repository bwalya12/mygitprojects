...
<body>
    ...
    // This will function to view the blog posts....
        ...
        <div class='card mb-4 shadow-sm'>
            <div class='card-body'>
                ...
                <div class='mb-3 text-muted'>
                    ...
                    <span class='date-posted'>| Date Posted: $currentTime</span> 
                </div>
            ...
            //     <div class = 'text-dark' ><h4>$title</h4></div>
            ...
            //     <p >Posted on: echo date('F Y d'); // Example output: May 2024 18</p>
            //     <hr>
